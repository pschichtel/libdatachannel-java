...
class LibDataChannelNative {
    ...
    static native void rtcClosePeerConnection(long peerHandle);
    ...
    static native long rtcAddTrack(long peerHandle, String sdp);
    static native long rtcAddTrackEx(long peerHandle, int direction, int codec);

    static native int rtcGetMaxDataChannelStream(long peerHandle);
    static native long rtcGetRemoteMaxMessageSize(long peerHandle);
    ...
    static native void rtcSetBufferedAmountLowThreshold(long channelHandle, int amount);
